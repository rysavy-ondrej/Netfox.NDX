...
final public class Rule_HEX extends Rule
{
  public Rule_HEX(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_HEX parse(ParserContext context)
  {
    context.push("HEX");
    ...
    if (parsed)
    {
        rule = new Rule_HEX(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("HEX", parsed);

    return (Rule_HEX)rule;
  }
}
