...
final public class Rule_token extends Rule
{
  public Rule_token(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_token parse(ParserContext context)
  {
    context.push("token");
    ...
    if (parsed)
    {
        rule = new Rule_token(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
